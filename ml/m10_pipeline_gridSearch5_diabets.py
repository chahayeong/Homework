...
'''
totla time :  37.3033709526062
Best estimator :  Pipeline(steps=[('minmaxscaler', MinMaxScaler()),
                ('randomforestclassifier',
                 RandomForestClassifier(max_depth=10, min_samples_leaf=7))])
Best_params_ : {'randomforestclassifier__max_depth': 10, 'randomforestclassifier__min_samples_leaf': 7, 'randomforestclassifier__min_samples_split': 2}
Best score  : 0.015832482124616958
'''