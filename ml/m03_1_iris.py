...
# model = LinearSVC()               # accuracy_score :  0.9523809523809523
# model = KNeighborsClassifier()  # accuracy_score :  0.9523809523809523
# model = LogisticRegression()      # accuracy_score :  0.9714285714285714
# model = DecisionTreeClassifier()  # accuracy_score :  0.9428571428571428
model = RandomForestClassifier()    # accuracy_score :  0.9333333333333333
