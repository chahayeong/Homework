...
train_p = pd.read_csv('/kaggle/input/optiver-realized-volatility-prediction/train.csv')
...
test[['row_id', 'target']].to_csv('submission_sub.csv',index = False)
...
# out_train = pd.read_csv('/kaggle/input/optiver-realized-volatility-prediction/train.csv')
out_train = pd.read_csv('/kaggle/input/optiver-realized-volatility-prediction/train.csv')
