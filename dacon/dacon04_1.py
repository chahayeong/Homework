...
data = pd.read_csv('./dacon/_data04/public_data/train.csv')
...
submission = pd.read_csv('./dacon/_data04/sample_submission.csv')
...
for date in public_date_list:
    test_df = pd.read_csv(f'./dacon/_data04/public_data/test_files/test_{date}.csv')
    data = pd.read_csv('./dacon/_data04/public_data/train.csv')
