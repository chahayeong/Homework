...
def read_train_test():
    train = pd.read_csv('./dacon/_data05/train.csv')
    test = pd.read_csv('./dacon/_data05/test.csv')
...
train_p = pd.read_csv('./dacon/_data05/train.csv')
...
test[['row_id', 'target']].to_csv('kksubmission_sub_01.csv',index = False)
...
out_train = pd.read_csv('./dacon/_data05/train.csv')
...
test_nn[['row_id', target_name]].to_csv('kksubmission_01.csv',index = False)
