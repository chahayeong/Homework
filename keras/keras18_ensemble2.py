...
from tensorflow.keras.layers import concatenate, Concatenate          # Concatenate 사용시 Concatenate()([output1, output2]) 
merge1 = Concatenate()([output1, output2])                            # concatenate 사용시 concatenate([output1, output2])  
