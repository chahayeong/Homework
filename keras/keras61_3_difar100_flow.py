...
x_argmented = x_argmented.reshape(x_argmented.shape[0], 32, 32, 3)
...
hist = model.fit(x_train, y_train, epochs=5, batch_size=8, verbose=2,
...
'''
acc :  0.2245263159275055
val_acc :  0.1956000030040741
val_loss :  3.3398499488830566
'''