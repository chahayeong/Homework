...
model.fit(x_train, y_train, epochs=100, validation_split=0.2, callbacks=[es, cp])
end_time = time.time() - start_time

model.save('./_save/ModelCheckPoint/keras48_1_MCP.hdf5')
...
'''
loss :  28.716201782226562
r2 score :  0.6486456602329066
'''