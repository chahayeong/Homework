...
model.add(Conv2D(filters=32, kernel_size=2,                          
                        padding='same', activation='relu', input_shape=(11, 1, 1))) 
model.add(Dropout(0.2))
model.add(Conv2D(300, 2, padding='same', activation='relu'))

model.add(Conv2D(168, 2, padding='same', activation='relu'))
model.add(Dropout(0.2))
...
'''
============== 이전 ===============
loss :  1.5158087015151978
accuracy :  0.5109361410140991

======= Conv2D =======
걸린시간 :  18.054612398147583
loss :  1.2456384897232056
