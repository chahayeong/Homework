...
model.fit(x_train, y_train, epochs=30, validation_split=0.2, callbacks=[es, cp])       # weights시 필요없음
...
'''
================ 이전
경과시간 :  5.383893251419067
loss :  4547.65380859375
r2 score :  0.36684066440666374

================ 
경과시간 :  2.34897518157959
loss :  3533.3232421875
r2 score :  0.5080635647966804
'''